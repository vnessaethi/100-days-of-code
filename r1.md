...
## R1D45
- I studied a little bit and again I keep doing more hands-on exercises in to create data structs to using in templates.

## R1D46
- I learned on how to escaping unsafe characters in templates and start to learn on how to create my own server on golang.

## R1D47
- I didn't get far, but I started to learn on how to consumming Marvel API and how to use authentication for server side applications.

## R1D48
- I tried to use Marvel API but I couldn't because of an authentication error and watched some videos from udemy course about TCP connection write and read connections using Golang.

## R1D49
- Today I was able to use Pokemon API I could get the information about pokemons and understanding on how it works.

## R1D50
- Learning more about TCP servers, read and write connections and Rot13 method on golang.

## R1D51
- Learning more about TCP servers, request response foundation and http multiplexer on Golang.

## R1D52
- Today I studied a little bit, I was understanding the net/http package on Golang.

## R1D53
- I continue studying the net/http package on Golang: request parse using forms and methods.
